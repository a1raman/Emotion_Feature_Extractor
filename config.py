...
############ For LINUX ##############
DATA_DIR = {
	'MER2023': '/mnt/ssd/sdd/khchoi/datasets/AIHUB_Kor/faceresult/dataset-process/splitVA',
}
PATH_TO_RAW_AUDIO = {
...
PATH_TO_PRETRAINED_MODELS = '/mnt/ssd/sdd/khchoi/checkpoints/'
PATH_TO_OPENSMILE = '/share/home/lianzheng/MER2023-Baseline-master/tools/opensmile-2.3.0/'
PATH_TO_FFMPEG = '/root/anaconda3/envs/llama/bin/ffmpeg'
